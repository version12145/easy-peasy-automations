...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "VEducate Academy" },
    ...
    links: [
      ...
      { rel: "preconnect", href: "https://veducateacademy.wasmer.app" },
      { rel: "dns-prefetch", href: "https://veducateacademy.wasmer.app" },
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&family=Instrument+Serif:ital@0;1&display=swap",
      },
    ],
  }),
